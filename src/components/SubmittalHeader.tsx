      ...
      {isEditing ? (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label className="block text-[10px] font-black text-zinc-400 uppercase mb-2 tracking-widest">
                Job / Project Name
              </label>
              <input
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    quote_number_mask: e.target.value,
                  })
                }
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
              <div>
                ...
                <p className="text-xs text-amber-600 mt-1 max-w-md">
                  <strong>Warning:</strong> Edits here will change this
                  customer's global profile. If you want to link this quote to a
                  different person entirely, reassign it instead.
                </p>
              </div>
              <button
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pr-10">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <span
                className="bg-zinc-100 text-zinc-600 px-2 py-0.5 rounded text-sm font-mono font-bold"
                title={`Original DB ID: ${submittal.quote_number}`}
              >
            ...
            <p className="text-zinc-500 text-sm">
              ...
              {formatPhoneNumber(customer.phone)} | Email:{" "}
              {customer.email || "N/A"}
            </p>
          </div>
