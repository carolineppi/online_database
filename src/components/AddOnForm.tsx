...
export default function AddOnForm({
  ...
  const [formData, setFormData] = useState({
    ...
    mounting_style:
      initialData?.mounting_style || "Floor Mounted / Overhead Braced",
    shipping_included: initialData?.shipping_included || "Includes Shipping",
    hardware_included:
      initialData?.hardware_included ||
        ...
        <form onSubmit={handleSubmit} className="p-10">
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full p-4 bg-zinc-50 rounded-2xl border-none ring-1 ring-zinc-200 focus:ring-2 focus:ring-emerald-500 transition appearance-none font-bold text-zinc-900"
                    onChange={(e) =>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="w-full p-4 bg-zinc-50 rounded-2xl border-none ring-1 ring-zinc-200 focus:ring-2 focus:ring-emerald-500 transition font-bold text-emerald-600"
                  onChange={(e) =>
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  ...
                  />
                  <select
                    className="w-full p-4 pl-12 bg-zinc-50 rounded-2xl border-none ring-1 ring-zinc-200 focus:ring-2 focus:ring-emerald-500 transition appearance-none font-bold text-zinc-900"
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                />
                <input
                  value={formData.hardware_included}
                  className="w-full p-4 pl-12 bg-zinc-50 rounded-2xl border-none ring-1 ring-zinc-200 focus:ring-2 focus:ring-emerald-500 transition font-bold"
                  onChange={(e) =>
                    setFormData({
                      ...formData,
                      hardware_included: e.target.value,
                    })
                  }
                />
              </div>
          ...
          <div className="flex gap-4 mt-10">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 p-5 bg-zinc-900 text-white rounded-2xl font-black hover:bg-emerald-600 transition uppercase tracking-widest text-[10px] shadow-xl shadow-zinc-200"
            >
