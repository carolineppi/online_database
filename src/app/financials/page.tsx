...
const fetchFinancialData = async () => {
    ...
    // 2. Fetch jobs - Now including the fixed add_ons join
  ...
  const formattedJobs = (jobsData || [])
    ...
    .filter((job): job is any => job !== null) // Remove the skipped items
    .filter(job => {
